...
start_process (void *f_name)
{
  ...
  *(thread_current()->process_load) = success;
  ...
  /* Haney: From here, the address of arguments will copied on stack  */
  int i;
  for(i = argc-1; i >= 0; i--){
    if_.esp -= sizeof(char *);
  ...
  /* Haney: From here, argv, argc, return address will copied on stack */
  // argv
...
process_wait (tid_t child_tid UNUSED) 
{
  ...
  // None of tid is matching with child_tid
  return -1;
}
